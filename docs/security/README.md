...
| [`adr-0013-c6-boleto-liquidacao-e-modalidade.md`](./adr-0013-c6-boleto-liquidacao-e-modalidade.md) | ADR (Aceito) — boleto e BolePix como modalidades escolhidas pelo chamador (`bolepix` sem chave EVP falha fechado), `external_reference_id` como bijeção de 26 chars do id local, e liquidação reconciliada por `/v2/bank_slips` em vez da leitura PIX (estende ADR-0005, exercita a cláusula residual do ADR-0002). |
