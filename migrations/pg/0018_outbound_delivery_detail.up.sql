-- GERADO por scripts/gen-pg-migrations.py a partir de ../0018_outbound_delivery_detail.up.sql — NAO EDITE A MAO.
...
ALTER TABLE account_outbound_delivery ADD COLUMN amount_cents BIGINT NOT NULL DEFAULT 0;
