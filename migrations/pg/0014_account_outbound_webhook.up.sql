-- GERADO por scripts/gen-pg-migrations.py a partir de ../0014_account_outbound_webhook.up.sql — NAO EDITE A MAO.
...
CREATE TABLE IF NOT EXISTS account_outbound_webhook (
    ...
    signing_secret_sealed BYTEA NOT NULL,    -- AES-256-GCM sealed HMAC secret; never plaintext
