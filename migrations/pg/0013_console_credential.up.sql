-- GERADO por scripts/gen-pg-migrations.py a partir de ../0013_console_credential.up.sql — NAO EDITE A MAO.
...
CREATE TABLE IF NOT EXISTS console_credential (
    ...
    totp_secret_sealed BYTEA NOT NULL, -- AES-256-GCM sealed TOTP secret; never plaintext
