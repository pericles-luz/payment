-- GERADO por scripts/gen-pg-migrations.py a partir de ../0004_pix_recurrence.up.sql — NAO EDITE A MAO.
...
CREATE TABLE IF NOT EXISTS pix_rec (
    ...
    valor_cents   BIGINT NOT NULL DEFAULT 0, -- 0 = unspecified/variable
